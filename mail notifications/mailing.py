...
devops_team_lead = "Gilad Trechtenberg"

devops_team = {
    "Gilad Trechtenberg": "Gilad437@gmail.com",
    "Eliran Ben Shitrit": "Eliranbenshtrit@gmail.com",
    "David Edri": "edridavid3@gmail.com",
    "Michal Dikun": "michal.dikun13@gmail.com"
}

mail = Mail(app)

def send_email(message, emails_list):
    email = Message(message, sender="gan.shmuel.bc.16@gmail.com",
